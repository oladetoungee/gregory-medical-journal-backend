...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    acceptedArticles: Attribute.Integer & Attribute.DefaultTo<0>;
...
export interface ApiChargeCharge extends Schema.CollectionType {
  ...
  attributes: {
    amount: Attribute.Integer & Attribute.Unique;
    type: Attribute.String & Attribute.Required & Attribute.Unique;
    details: Attribute.Text & Attribute.Required & Attribute.Unique;
    currency: Attribute.String & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiEthicEthic extends Schema.CollectionType {
...
export interface ApiManuscriptManuscript extends Schema.CollectionType {
  ...
  attributes: {
    heading: Attribute.String & Attribute.Required & Attribute.Unique;
    paragraph: Attribute.Text & Attribute.Required & Attribute.Unique;
    list: Attribute.Blocks & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiMemberMember extends Schema.CollectionType {
  ...
  attributes: {
    ...
    bio: Attribute.Text & Attribute.Required & Attribute.Unique;
    image: Attribute.Media<'images'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
